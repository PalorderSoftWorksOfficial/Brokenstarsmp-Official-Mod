...
public final class IdentityCompat {
    ...
    public static PlayerRef of(ServerPlayerEntity p) {
    ...
    private static boolean isNameAndId(Object o) {
        ...
        return n.equals("net.minecraft.server.players.NameAndId")
                || n.endsWith(".NameAndId")
                || n.contains("yggdrasil.response.NameAndId");
    }
    ...
    public static PlayerRef fromUnknown(Object any) {
        ...
        if (any instanceof ServerPlayerEntity sp) return of(sp);
    ...
    public static Collection<PlayerRef> getArgAsPlayerRefs(
        ...
        Collection<?> raw = GameProfileArgumentType.getProfileArgument(ctx, argName);
        return raw.stream()
    ...
    private static GameProfile tryExtractGameProfileByType(Object any) {
        ...
        for (Method m : any.getClass().getMethods()) {
            ...
            try {
                ...
                switch (val) {
                    case GameProfile g when GameProfile.class.isAssignableFrom(rt) -> {
                        return g;
                    }
                    case Optional<?> opt -> {
